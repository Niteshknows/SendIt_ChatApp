...
import com.example.sendit_chatapp.databinding.ActivitySettingBinding;
...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.backbtnofsetting.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        Users users = snapshot.getValue(Users.class);
                            ...
                            Picasso.get()
                                    ...
                                    .into(binding.profileImageInSetting);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
       ...
       if(data.getData()!=null) {
           ...
           binding.profileImageInSetting.setImageURI(sFile);
